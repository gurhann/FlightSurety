...
contract FlightSuretyApp {
    ...
    */
    ...
    modifier requireAirlineNotVoted(address airlineAddress) {
        require(
            !checkIfContains(airlineVoters[airlineAddress]),
            "You already voted to register this airline."
        );
        _;
    }
    ...
    function checkIfContains(address[] memory voters)
        internal
        view
...
abstract contract FlightSuretyData {
    ...
    function isActive ( address airline) public virtual view returns(bool);
    function registerAirline(address airlineAddress, string memory name) external virtual returns(bool);
    function getAirlineVotes(address airline) public virtual view returns (uint256 votes);
    function creditInsurees (string memory flightCode) external virtual;
